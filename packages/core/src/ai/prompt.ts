...
export const generateReply = [
  ...
  "6. Before using any prebuilt shadcn component, use the `get-component-info` function to retrieve its documentation and examples.",
  "7. You have access to the following prebuilt shadcn components:",
  ...Object.values(knowledgeBase).map(
    (doc) => `   - ${doc.title}: ${doc.description}`,
  ),
  "8. After retrieving shadcn component information, incorporate it into your solution appropriately.",
  "9. Provide a complete, well-formatted React component code, including necessary imports for shadcn components.",
  "10. Do not use any libraries or components other than the shadcn components listed above.",
  "11. Ensure your code is functional, well-structured, and follows best practices for using shadcn components.",
  "12. After the component code, provide a brief explanation of how the component works, including how shadcn components are utilized, and any key features or decisions made in its implementation.",
